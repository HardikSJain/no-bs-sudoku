...
class FeedbackContext {
  ...
  static Future<FeedbackContext> gather({
    ...
    // dart:io rather than a device-info plugin. It gives the platform and
    // the OS build, which is what a bug report needs; the model number is
    // the one thing it misses, and screen size already covers the case that
    // was really about — a layout going wrong on a small phone.
